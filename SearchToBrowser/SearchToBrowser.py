...
IGNORE_FONT_NAMES:List[str] = ['ballet', 'bigelow rules', 'bytesized', 'comforter', 'festive', 'flow block', 'Flow Rounded', 'inspiration', 'jersey 20 charted', 'micro 5 charted', 'mrs sheppards', 'notable', 'Pinyon Script', 'redacted', 'sankofa display', 'splash', 'vina sans', 'wavefont', 'windsong']
